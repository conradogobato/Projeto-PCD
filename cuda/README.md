...
Para todas as configurações testadas — incluindo diferentes números de blocos na grelha — o valor final do erro quadrático total (SSE) foi idêntico:

**SSE final obtido: `1626392838244.792480`**

Isso indica que o resultado final do algoritmo é independente da configuração de paralelismo (desde que o número de threads seja suficiente para cobrir todos os pontos), sendo afetado apenas o tempo de execução.
