...
### 2.
./n_parallel dados_random.csv centroids_random.csv [max_iter=50] [eps=1e-4] [assign.csv] [centroids.csv]

## Run on Ubuntu
### 1.
gcc -O2 -std=c99 -f n_parallel n_parallel.cpp -o n_parallel -lm
### 2.
./n_parallel dados_random.csv centroid_random.csv [max_iter=50] [eps=1e-4] [assign.csv] [centroids.csv]
